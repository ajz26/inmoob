...
class ProperytyRooms extends Select {
    static  $shortcode   = "inmoob_sf_property_rooms_select";

    static function get_values(){

        $values     = Api::get_terms_select('property_rooms_taxonomy');
    ...
    private static function set_selected(&$option): object{
        $category = get_query_var('property_rooms_taxonomy') ?:  get_query_var('property_type');
